...
class river:
    def __init__(self, continent, river_weight=100, size_continent=100): #river_weight assumed to be value 1-100
        ...
        if self.rivers_count == None:
            ...
            self.rivers_count = int((self.count_vectors()*river_percent)) #Number of river can be dynamic by exchanging 0.25 with a user inserted value
    ...
    def generate_river(self):
        for i in range(self.rivers_count):
            ...
            pos_3 = (mid_point[0]+direction[0], mid_point[1]+direction[1]) #This is The initialized vector for the river
            ...
            for i in range(5): #Makes 5 river vectors
    ...
    def generate_xy_pos(self, last_touple, u1, u2):
        ...
        while True:
            ...
            if xrandom != 0 and yrandom != 0: #Make sure that we do not get the same position resulting in division by 0
                ...
                if -50 < self.vectorangle(first_vector, tempvector) < 50 and norm_v != 0:
                    return next_pos
                    False
    ...
    def normal_vector(self, p1, p2):
        ...
        if magnitude != 0:
            ...
            normal = (normal[0]*-5,normal[1]*-5) #Without - and 5 they are pointing in the wrong direction + too small
        else:
